...
const UngDung = () => {
  ...
  return (
    <div>
      <div>
        <div id="ungdung" className={classes.container__App}>
          <div className="container p-5">
            <div
              className="container__app d-flex"
              style={{ width: "800px", paddingTop: "200px" }}
            >
              <div
                className="button__text__app"
                style={{
                  width: "500px",
                  marginRight: "100px",
                  color: "white",
              ...
              >
                <div className={classes.text__app}>
                ...
                <a target="__blank" href="https://apps.apple.com/us/app/123phim-mua-ve-lien-tay-chon/id615186197">
                  <button className={classes.btn__app}>
                    APP MIỄN PHÍ - TẢI VỀ NGAY
                  </button>
                </a>
                <div className="text__app mt-3">
                  <p>
