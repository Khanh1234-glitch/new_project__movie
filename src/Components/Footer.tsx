    ...
    <div>
      ...
      >
        <header className="footer container">
          <div className="content__footer  p-5 ">
            <div className="row">
              <div className="col-sm-5 col-12 col-md-5 col-lg-6" style={{width:"500px"}}>
          ...
          >
            ...
            <div
              className="content__info__footer"
              style={{ maxWidth: "100vh" }}
            >
              <p
                className={classes.content__info}
